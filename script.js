...
const i18n = {
  pt: {
    ...
    operComp: "Análise e otimização de processos, interpretação de indicadores e métricas operacionais, tomada de decisão baseada em dados, organização e estruturação de fluxos de trabalho, resolução de problemas, liderança e coordenação de equipes, comunicação entre áreas e melhoria contínua de processos",
  ...
  en: {
    ...
    operComp: "Process analysis and optimization, interpretation of operational indicators and metrics, data-driven decision making, organization and structuring of workflows, complex problem solving, team leadership and coordination, cross-department communication, and continuous process improvement",
